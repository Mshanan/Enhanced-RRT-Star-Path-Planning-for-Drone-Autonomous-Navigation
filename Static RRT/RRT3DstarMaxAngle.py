...
def pathPlanning(start, goal, obstacles):
    ...
    def rewire(new_node, node_array, parent_array, cost_array, obstacles):
        ...
        for i in near_indices:
            ...
            if not collision(new_node, near_node, obstacles) and not max_turning_angle(nearest_node, new_node, parent_array):
    ...
    max_iter = 8000  # Maximal number of sample points
    ...
    for i in range(max_iter):
        ...
        if not collision(nearest_node, new_node, obstacles) and not max_turning_angle(nearest_node, new_node, parent_array):
